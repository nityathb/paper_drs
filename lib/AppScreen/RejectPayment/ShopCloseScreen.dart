// ignore_for_file: file_names, non_constant_identifier_names, avoid_print, deprecated_member_use, must_be_immutable
...
class ShopCloseScreen extends StatefulWidget {
  String retailercode,
      categoryId,
      retailerName,
      colorCode,
  ...
  ShopCloseScreen(
      ...
      : super(key: key);
  @override
  State<ShopCloseScreen> createState() => _ShopCloseScreenState();
}

class _ShopCloseScreenState extends State<ShopCloseScreen> {
      ...
      body: CustomBackgound(
        ...
        child: Column(
          children: [
            ...
            InkWell(
                onTap: () {
                  updateShopCloseStatusAPI(_image);
                },
                child: Container(
                    height: 45,
  ...
  updateShopCloseStatusAPI(PickedFile? _image) async {
    if (_image == null) {
      ...
      request.fields["DeniedReason"] = "Shop Close";
      ...
      if (response.statusCode == 200) {
        ...
        ShopClosePopUp(userName, companyId);
